...
<section class="inner_banner">
    ...
    <div class="container">
        <div class="inner_banner_content">
            <h1>PRIVATE JET PROGRAMS</h1>

        </div>
    </div>
</section>

<section class="programs_section padd-y">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <figure class="programs_img">
                    <img src="images/program-img2.webp" alt="image" class="img-fluid">
                </figure>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-6">
                <figure class="programs_img">
                    <img src="images/program-img3.webp" alt="image" class="img-fluid">
                </figure>
            </div>
            <div class="col-md-6">
                <div class="programs_content">
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <figure class="programs_img">
                    <img src="images/program-img4.webp" alt="image" class="img-fluid">
                </figure>
            </div>
            <div class="col-md-6">
                <div class="programs_content">
        ...
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-6">
                <figure class="programs_img">
                    <img src="images/program-img5.webp" alt="image" class="img-fluid">
                </figure>
            </div>
            <div class="col-md-6">
                <div class="programs_content">
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <figure class="programs_img">
                    <img src="images/program-img1.webp" alt="image" class="img-fluid">
                </figure>
            </div>
            <div class="col-md-6">
                <div class="programs_content">
